        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-blue-500 to-purple-600 overflow-hidden shadow-sm sm:rounded-lg mb-8">
                <div class="p-6 text-white">
                    ...
                    <p class="text-blue-100">Check your latest results and academic progress</p>
                </div>
            </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">3.75</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-8">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <a href="#" class="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition duration-200">
                            <svg class="w-8 h-8 text-blue-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                            </svg>
                            <div>
                                <p class="font-medium text-gray-900">View Results</p>
                                <p class="text-sm text-gray-500">Check your exam results</p>
                            </div>
                        </a>

                        <a href="#" class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition duration-200">
                            <svg class="w-8 h-8 text-green-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                            </svg>
                            <div>
                                <p class="font-medium text-gray-900">Download Marksheet</p>
                                <p class="text-sm text-gray-500">Get your official marksheet</p>
                            </div>
                        </a>

                        <a href="#" class="flex items-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition duration-200">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Terminal Exam</td>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Assessment</td>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                            ...
                            <div class="ml-4 flex-1">
                                <h4 class="text-sm font-medium text-gray-900">Social Studies - Final Exam</h4>
                                <p class="text-sm text-gray-500">December 15, 2024 at 10:00 AM</p>
                            </div>
                            <div class="text-sm text-yellow-600 font-medium">In 3 days</div>
                        </div>
                        ...
                        <div class="flex items-center p-4 bg-blue-50 border border-blue-200 rounded-lg">
                            ...
                            <div class="ml-4 flex-1">
                                <h4 class="text-sm font-medium text-gray-900">Computer Science - Practical</h4>
                                <p class="text-sm text-gray-500">December 18, 2024 at 2:00 PM</p>
                            </div>
                            <div class="text-sm text-blue-600 font-medium">In 6 days</div>
                        </div>
                        ...
                        <div class="flex items-center p-4 bg-green-50 border border-green-200 rounded-lg">
                            ...
                            <div class="ml-4 flex-1">
                                <h4 class="text-sm font-medium text-gray-900">Nepali - Terminal Exam</h4>
                                <p class="text-sm text-gray-500">December 20, 2024 at 9:00 AM</p>
                            </div>
                            <div class="text-sm text-green-600 font-medium">In 8 days</div>
                        </div>
                    </div>
                </div>
            </div>
